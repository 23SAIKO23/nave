function initCanvas(){
    ...
    enemiespic2.src     = "images/enemigo2.png"; //Foto de enemigos
    
    // anchura y altura (canvas)
    ...
    // Para reducir una función repetitiva o dos, hice algunos cambios leves en la forma en que creas enemigos..
    var enemies = [
    ...
    function Launcher(){
        ...
        this.h = 100,   
        this.direccion, 
        this.bg="white", // color de bala (color de bala)
        this.misiles = [];
        ...
        this.render = function () {
            ...
            for(var i=0; i < this.misiles.length; i++){
                ...
                if(m.y <= 0){ // If un misil pasa los límites del lienzo, retírelo
        ...
        this.hitDetectLowerLevel = function(enemy){
            ...
            if ((enemy.y < this.y + 25 && enemy.y > this.y - 25) &&
                (enemy.x < this.x + 45 && enemy.x > this.x - 45)) { // Comprobando si el enemigo está a la izquierda o a la derecha de la nave espacial
                    this.gameStatus.over = true;
   ...
   document.addEventListener('keydown', function(event) {
    ...
    //Este código a continuación dispara balas (balas)
